...
根据截图中的文件名，数据集包含以下主要子集：

1.  **BioTISR_CCPs**: 网格蛋白小窝 (Clathrin-Coated Pits) 2. **BioTISR_F-actin**: 丝状肌动蛋白 (线性 SIM 模式) 3. **BioTISR_F-actin_nonlinear**: 丝状肌动蛋白 (非线性 SIM 模式，分辨率更高)
2.  **BioTISR_Lysosomes**: 溶酶体 5. **BioTISR_Microtubules**: 微管 6. **BioTISR_Mitochondria**: 线粒体 (可能包含 OMM 外膜)
